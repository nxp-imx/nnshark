...
gboolean gst_liveprofiler_init (gint cpu_num, gint gpu_num, gint ddr_num, gint pwr_num);
...
void update_pwrusage_event (guint32 pwrnum, gfloat * pwrvalue, gchar **names);
